...
class LoanedBookInstanceByUserListViewTest(TestCase):
    def setUp(self):
        # Create 2 users
        test_user1 = User.objects.create_user(username='testuser1', password='XxXxYyYy321')
        test_user2 = User.objects.create_user(username='testuser2', password='XxXxYyYy4321')
    ...
    def test_logged_in_uses_correct_template(self):
        login = self.client.login(username='testuser1', password='XxXxYyYy321')
        response = self.client.get(reverse('my-borrowed'))
