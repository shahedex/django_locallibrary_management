...
class Language(models.Model):
    """Model representing the language a book is written"""
    name = models.CharField(
        max_length=200, help_text='Enter the book language (e.g. Arabic, Farsi)')
...
class Book(models.Model):
    ...
    # ManyToManyField used because a language can contain many books and language can cover many books
